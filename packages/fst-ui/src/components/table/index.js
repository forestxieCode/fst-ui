...
import FstSelect from './fields/select'
...
const FstTable = {
  ...
  methods: {
    ...
    $_renderTable(h) {
      ...
      const table = (
        <div class="fst-table__container">
          <Table
            data={data}
            highlightCurrentRow
            rowKey={rowKey}
          ...
          {...{
            ...
            scopedSlots: {
              default: ({ row, column, $index }) => {
                ...
                return (
                  <Link type="primary" onClick={onClick} class="fst-table__link">
                    {row[prop]}
                  </Link>
                )
              }
    ...
    $_renderActionColumn(h, column) {
      ...
      return (
        <TableColumn
          ...
          align={align}
          width={width}
          className="fst-table__actioncolumn"
          {...{
            scopedSlots: {
              default: ({ row, column, $index }) => {
    ...
    $_renderEditColumn(h, column) {
      ...
      return (
        <TableColumn
          ...
          align={align}
          showOverflowTooltip
          labelClassName={isRequired ? 'fst-table__column--required' : ''}
          {...{
            scopedSlots: {
              default: scope => {
                if (
    ...
    $_renderToolbar(h) {
      ...
      if (buttons || toolbarSlot) {
        return (
          <div class="fst-table__toolbar">
            <div class="fst-table__buttons">
              {buttons}
              {/** 可以将自定义内容插入工具条 */}
              {toolbarSlot}
            </div>
  ...
  render(h) {
    ...
    return (
      <div class="fst-table" style={{ height: this.tableContainerHeight }}>
        {toolbar}
        {table}
        {page}
      </div>
...
FstTable.install = function (app) {
  app.component(FstTable.name, FstTable)
}
